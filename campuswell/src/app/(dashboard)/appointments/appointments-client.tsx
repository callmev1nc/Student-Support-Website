...
import { appointmentStatusStyles, appointmentStatusLabels } from '@/lib/format'
                  ...
                  >
                    ...
                    >
                      <CardContent className="flex flex-col gap-2 py-4 sm:flex-row sm:items-center sm:gap-4">
                        ...
                        {/* Status badge */}
                        <span
                          className={`shrink-0 rounded-full px-2.5 py-0.5 text-xs font-medium ${appointmentStatusStyles[appointment.status] ?? appointmentStatusStyles.PENDING}`}
                        >
